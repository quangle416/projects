...
public class MainJavaBasics {
	...
	public static void main(String[] args) {
		 ...
		 *	Answer: The sum must be a double variable type.  
		 */
		int m = 25;
		double n = 55.11;
		double o = n+m;
		 ...
		 *What happens?
		 *	Answer: You get an error because you are dividing to different variables.
		 *You can type case the variable or change it to a double to get a better result.
		 *What corrections are needed?
		 *	Answer: I simple changed the int value with decimals to a double and changed the result to a double variable. 
		 */
		int aa = 25;
		double bb = 45.5;
		double cc = bb/aa;
		...
		System.out.println("The perimeter of a cirle with a radius of 5 cm is " + perimeter);
		...
		double order = (3*coffee)+(4*cappuccino)+(2*expresso);
		
		System.out.println(order);
		
		double subtotal = order;
		double SALES_TAX = subtotal * .06;
